...
const BMICalculator = () => {
  ...
  return (
    <>
      <SEO
        title="BMI Calculator - Smart Student Tools"
        description="Calculate your Body Mass Index (BMI) with metric or imperial units. Get health tips, history, and a shareable result card."
